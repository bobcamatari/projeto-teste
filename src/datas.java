...
public class datas {
	...
	public static void main(String[] args) throws ParseException {
		...
		Date y1 = sdf1.parse("25/02/2020");
		Date y2 = sdf2.parse("25/02/2020 21:20:15");
		Date y3 = Date.from(Instant.parse("2020-02-25T15:04:03Z"));
		Date x1 = new Date();
		...
		datual = cal.getTime();
		System.out.println(sdf2.format(datual));
